...
Versões atuais (índice rápido — confira no index.html antes de bumpar): `config v=31`, `auth v=32`, `api v=31`, `groups v=33`, `ui v=38`, `gm v=32`, `aovivo v=37`, `evento v=42`, `copa v=7`. (gm/index.html: `admin v=44`)
...
- **2026-06-22** — **Copa: botão dourado central no menu + Final centralizada** (index.html + js/copa.js). Bottom-nav ganhou um **FAB dourado 🏆 Copa no centro** (elevado, `-mt-9`, gradiente amber, leva pra view-copa). ⚠️ Pra centralizar o FAB, o botão **Desafios saiu do bottom-nav** (view-desafios continua acessível por código, mas perdeu o atalho na barra) — decisão a confirmar com o Kevin. Itens agora usam `flex-1` (antes `w-[20%]`). Final do bracket centralizada e destacada (`.bkt-final`: card maior 200px + borda dourada). Bump copa v=7.
