...
Versões atuais (índice rápido — confira no index.html antes de bumpar): `config v=31`, `auth v=32`, `api v=31`, `groups v=34`, `ui v=40`, `gm v=32`, `aovivo v=38`, `evento v=42`, `copa v=8`. (gm/index.html: `admin v=44`)
...
- **2026-06-23** — **Botão de doação / "Apoiar o app"** (index.html + js/ui.js). Modal `modal-doacao` (❤️) com explicação (ajuda a pagar API-Football + hospedagem), valores sugeridos R$5/10/20 e chave PIX **CPF 017.491.322-22 (Kevin Schwanke)** com botão copiar (`copiarPixDoacao` copia os dígitos `01749132222`, fallback prompt). Acesso por banner ❤️ na home do grupo (após Desafios) e botão em Configurações (view-painel). Bump ui v=40. HTML servido direto.
