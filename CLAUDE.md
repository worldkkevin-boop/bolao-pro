...
Versões atuais (índice rápido — confira no index.html antes de bumpar): `config v=31`, `auth v=32`, `api v=31`, `groups v=33`, `ui v=37`, `gm v=32`, `aovivo v=35`, `evento v=42`. (gm/index.html: `admin v=42`)
